...
import net.minecraft.server.v1_5_R2.NoiseGeneratorOctaves;
import net.minecraft.server.v1_5_R2.WorldGenCaves;
import net.minecraft.server.v1_5_R2.WorldGenCavesHell;
import net.minecraft.server.v1_5_R2.WorldGenNether;
