...
import net.minecraft.server.v1_5_R1.NoiseGeneratorOctaves;
import net.minecraft.server.v1_5_R1.WorldGenCaves;
import net.minecraft.server.v1_5_R1.WorldGenCavesHell;
import net.minecraft.server.v1_5_R1.WorldGenNether;
